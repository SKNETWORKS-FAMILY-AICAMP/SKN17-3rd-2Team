...
def build_chain(option_name):
    ...
    if option_name == "청년매입임대":
        ...
        source = './data\25년_3차_청년매입임대_공급주택목록(서울지역본부).txt'
        ...
        source = './data\25년3차_신혼·신생아매입임대Ⅰ_공급주택목록(서울지역본부).txt'
        ...
        source = './data\25년3차_신혼·신생아매입임대Ⅱ(전세형)_공급주택목록(서울지역본부).txt'
...
# ──────────────────────────────────────────────────────────────────────────────
st.header("💬Chat bot")
rag_chain, gu_li, source = build_chain(option_name)
